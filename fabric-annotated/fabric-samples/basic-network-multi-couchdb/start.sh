...
function StartDocker()
{
   ...
   docker-compose -f docker-compose.yml up -d ca0.example.com ca1.example.com orderer.example.com couchdb0 couchdb1 couchdb2 couchdb3 peer0.org1.example.com peer1.org1.example.com peer0.org2.example.com peer1.org2.example.com cli
}
