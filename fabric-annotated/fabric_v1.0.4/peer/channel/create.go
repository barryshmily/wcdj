...
func sendCreateChainTransaction(cf *ChannelCmdFactory) error {
	...
	logger.Debugf("[gerry] channelTxFile[%s]", channelTxFile)
	if channelTxFile != "" {
...
func create(cmd *cobra.Command, args []string, cf *ChannelCmdFactory) error {
	...
	logger.Debugf("[gerry] chainID[%s]", chainID)
	...
	var err error
	if cf == nil {
		logger.Debugf("[gerry] cf == nil EndorserNotRequired[%d] OrdererRequired[%d]",
		EndorserNotRequired, OrdererRequired)
